...
# Set up the website page config with a wide layout to support the side-by-side view
st.set_page_config(page_title="MLB Pitch Movement Graph Generator", layout="wide")

# Custom CSS for a professional, minimalist dark theme with full-screen side-by-side panels
st.markdown("""
    <style>
    ...
    /* Completely hide the clunky sidebar background wrapper and top default header */
...
# CREATE MAIN SCREEN COLUMNS (Left for input controls, Right for the actual graph output)
            ...
            try:
                ...
                if id_table.empty:
                    ...
                    if raw_data.empty:
                        ...
                        # Premium Original Color Theme Canvas Setup
                        plt.style.use('dark_background')
                        fig, ax = plt.subplots(figsize=(9, 9))
                        fig.patch.set_facecolor('#121212')
                        ax.set_facecolor('#121212')

                        # restored your colorful palette mappings
                        master_colors = {
                        ...
                        legend = ax.legend(title='Pitch Arsenal', loc='upper right', frameon=True, facecolor='#1E293B', edgecolor='#2D2D2D', fontsize=10)
                        ...
                        # Display inline stats summaries
